...
function Invest() {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(async () => {
      setPost(false);
      await toastrRef.current?.add("Tambah pengajar berhasil!", "Status", { duration: 0, hasIcon: true });
      setTimeout(() => {
        router.back();
      }, 1000);
    }, 5000);
            ...
            <Card>
              ...
              <CardBody>
                <form method="Post" onSubmit={handleSubmit}>
                  <Input fullWidth>
                    <input type="text" placeholder="Nama" name="title" onChange={(e) => setName(e.target.value)} />
                  </Input>
                  <Input fullWidth>
                    <textarea type="text" placeholder="Bidang" name="desc" onChange={(e) => setRole(e.target.value)} />
                  </Input>
                  <label>
