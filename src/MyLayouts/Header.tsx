...
const Header: React.FC<HeaderProps> = (props) => {
  ...
  const { docs }: any = useFirestore('web-info');
  const themeOptions = () => [
    {
      value: 'default',
      label: (
    ...
    <LayoutHeader fixed>
      <HeaderStyle>
        <Actions
          ...
          actions={[
            ...
            },
            {
              content: (
                <Link href="/">
                  <a className="logo">TK Aba Admin Panel</a>
                </Link>
              ),
            },
            {
        ...
        <Actions
          ...
          actions={[
            {
              content: <img height="50" src={docs[0] ? docs[0].logo : '/images/logo.jpg'} alt="slack" />,
            },
            {
              content: (
                <ContextMenu
                  ...
                  items={[{ title: 'Log out', link: { href: '/logout' } }]}
                  Link={Link}
                >
                  <User image="url('/images/avatar.png')" name="Admin" title="Admin" size="Medium" />
                </ContextMenu>
              ),
            },
          ]}
